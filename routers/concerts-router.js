...
const { DATABASE, PORT, TKM_KEY } = require('../config');
...
router.get('/concerts', (req, res) => {
  ...
  // console.log('this is the tkm key',TKM_KEY)
  // console.log(`https://app.ticketmaster.com/discovery/v2/events.json?apikey=wCHbhAq3GitRal013GIynrAfLxPqmQqB&city=atlanta&countryCode=US&classificationName=music`);  
  ...
  fetch(`https://app.ticketmaster.com/discovery/v2/events.json?apikey=${TKM_KEY}&startDateTime=${startDateTime}&endDateTime=${endDateTime}&city=${req.query.city}&countryCode=US&classificationName=music`)
